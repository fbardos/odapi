...
class ExcelResource(ConfigurableResource):
    ...
    def load_excel_by_url(self, url: str, source: Optional[str] = None, **kwargs) -> pd.DataFrame:
...
class SssExcelResource(ExcelResource):
    ...
    def add_year_column(self, df: pd.DataFrame, partition_year: str, year_offset: int = 1) -> pd.DataFrame:
